...
def get_teamID(team):
    if team == "Kannur Warriors FC":
        return 27
    elif team == " KOCHI FORCA FC" :
        return 20
    elif team == "Calicut FC":
        return 22
    elif team == "THIRUVANANTHAPURAM KOMBANS":
        return 24
    elif team == "Malappuram Football Club":
        return 21
    elif team == "Thrissur Magic FC":
        return 25
